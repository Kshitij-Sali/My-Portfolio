...
const About = () => {
  ...
  const timeline = [
      {
    title: 'Pursuing IT Engineering',
    company: "PES Modern CoE, Pune",
    period: 'Present',
    description: 'Completing B.E. in IT Engineering, building a strong foundation in problem-solving and technical skills.',
    type: 'education'
  },
  {
  ...
  return (
    ...
    digital experiences with precision and creativity.
              ...
              <div className="text-charcoal-200 space-y-4 mb-10 max-w-2xl">
                <p>
                  I'm Kshitij Sali, an engineering student specializing in Information Technology, with a strong interest in UI design and front-end technologies. As a fresher in the field, I bring a solid foundation in UI design principles, along with hands-on experience using tools like Figma and Canva.
                </p>
                <p>
                  In addition to design, I also have a working knowledge of programming languages such as Java, Python, and JavaScript, which helps me bridge the gap between design and development.
                </p>
                <p>
                  I’m a creative thinker, a detail-oriented problem-solver, and someone who values perfection and clean execution in every task. My peers and mentors often appreciate the clarity, aesthetics, and usability in my work — something I take great pride in.
                </p>
                <p>
                  I’m passionate about solving real-world problems through design, especially by creating user-friendly interfaces that reduce friction and frustration. My goal is to grow in the UI/UX industry, contributing to solutions that truly make users' lives easier.
                </p>
              </div>
              ...
              >
                <div className="bg-charcoal-800/50 backdrop-blur-sm rounded-lg p-4 border border-charcoal-700">
                  ...
                  <p className="text-charcoal-300 text-sm">MongoDB, Express, React, Node,JavaScript, Java</p>
                </div>
