...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('access_key', '89d00c5d-3cf6-40ee-8a4f-4cc5483e83e2'); // Replace with your Web3Forms access key
  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "sali.kshitij2404@outlook.in",
      link: "mailto:sali.kshitij2004@outlook.in"
    },
    {
      icon: <MapPin className="h-5 w-5" />,
      label: "Location",
      value: "Pune, Maharashtra, India",
      link: "https://maps.app.goo.gl/zVRdL7U7UcW54rss8"
    },
    {
      icon: <Phone className="h-5 w-5" />,
      label: "Phone",
      value: "+91 8983151615",
      link: "tel:+918983151615"
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            >
              Drop a <span className="text-flame-500">Message</span>
            </motion.h1>
